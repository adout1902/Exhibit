...
function setup(mode) {
    ...
    $('#browse').click(function(){
       ...
       window.open("/home/ubuntu/public_html/cgi-bin/browse.py");
    ...
    $('#populate').click(function(){
        window.open("./cgi-bin/populate.py?name="+template.name);
    });
...
function editTemplate(){
    ...
    template.backgroundColour = editTemplate["bgColor"];
    document.body.style.backgroundColor = editTemplate["bgColor"];
...
function openEditMenu() {
    ...
    document.getElementById("template-controls").style.marginLeft="200px"
}
  ...
  function closeEditMenu() {
    ...
    document.getElementById("template-controls").style.marginLeft="500px"
