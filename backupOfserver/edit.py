...
if (username is None or not username or username=="" or username=="undefined" or username=="null"):
    uname = "no one logged in."
...
print("""
    ...
    <link rel="stylesheet" href="../css/templateEditor.css">
...
<body onload="setup("""+str(templateID)+""")" id="body">
    ...
    <div  class="workspace" id="exhibit-space">
        ...
        <nav class="navbar navbar-expand-md navbar-dark" id="control-panel" style="background-color: rgb(214, 214, 212)">
            <div class="navbar-collapse collapse w-100 order-1 order-md-0 dual-collapse2">
                    <div>
		    <a id="" class="navbar-brand" href="../landingPage.html"style="color:#ffffff">EXHIBIT</a>
	            <small class="card-subtitle mb-2 text-muted">logged in: """+uname+"""</small>
		    </div>
                <!-- <ul class="navbar-nav mr-auto"> -->
                    ...
                    <!-- </li>
                    <li>              -->
                        <div class="input-group" id="colour-panel" style="margin-left:1rem;">
                                <input type="color" class="" value="#ffffff" id="change-bg-colour" style="height: 30px;">
                            	<div class="input-group-append">
					<button class="btn btn-sm btn-outline-secondary" type="button" style="margin:0">ok</button>
				</div>
			
			</div>
                        <button id="add-page" class="btn btn-sm btn-outline-secondary" type="button">add page</button>
			<button id="rem-page" class="btn btn-sm btn-outline-secondary" type="button">remove page</button>

                        <div id="no-pages" style="padding-left:1rem"></div>
    ...
    <div id="modal-content">
	   ...
	   <div id="collab-display">Allowed to edit: <span style="font-size: small;" id="display-collab"></span></div>	
           <div id="modal-buttons">
                <button id="save-template"></button>
                <button id="update-template">update</button>
           </div>
            <button id="modal-close" class="close-bttn">close</button>            
    </div>
